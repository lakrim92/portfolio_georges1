...
Video by [Rahul Sharma](https://www.pexels.com/@rahul-sharma-493988) bnom [Pexels](https://www.pexels.com).
...
sequenceDiagram
    participant Alice
    participant Bob
    Alice->>Georges: Hello Georges, how are you?
    loop Healthcheck
        Georges->>Georges: Fight against hypochondria
    end
    Note right of Georges: Rational thoughts <br/>prevail!
    Georges-->>Alice: Great!
    Georges->>Bob: How about you?
    Bob-->>Georges: Jolly good!
{{< /mermaid >}}
